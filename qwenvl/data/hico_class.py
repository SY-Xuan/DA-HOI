...
actionname2id = {item['name']: item['id'] for item in HICO_ACTIONS}
objectname2id = {item['name']: index for index, item in enumerate(HICO_OBJECTS)}

HOIINDEX2OBJECTVERB = {item['interaction_id']: (actionname2id[item['action']], objectname2id[item['object']]) for item in HICO_INTERACTIONS}
