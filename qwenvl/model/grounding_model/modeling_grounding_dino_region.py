...
from transformers.models.grounding_dino.modeling_grounding_dino import MultiScaleDeformableAttention, GroundingDinoConvEncoder, build_position_encoding, GroundingDinoConvModel, GroundingDinoMLPPredictionHead, get_sine_pos_embed, generate_masks_with_special_tokens_and_transfer_map, GroundingDinoObjectDetectionOutput
...
class GroundingDinoForObjectDetection(GroundingDinoPreTrainedModel):
    ...
    def forward(
        ...
        return GroundingDinoObjectDetectionOutput(logits=logits, pred_boxes=pred_boxes, last_hidden_state=outputs.last_hidden_state, intermediate_hidden_states=outputs.intermediate_hidden_states,)
